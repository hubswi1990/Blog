...
<form role="form" action="./newarticle" method="post" onsubmit="validatesForm()">
	<div class="form-group">
		<label>Article Name</label> 
		<input name="articlename" type="text" class="form-control" placeholder="Enter Article Name">
	</div>
	<div class="form-group">
		<textarea name="textarea" id="tinyeditor" style="width: 100%; height: 200px"></textarea>
		<script>
